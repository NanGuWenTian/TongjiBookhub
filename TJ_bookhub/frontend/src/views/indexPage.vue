<template>
  <div class="welcome-container">
    ...
    <!-- 登录模态框 -->
    <LoginModal v-if="showLoginModal" @close="closeModal" @switch-to-register="showRegisterModal = true" />
    
    <!-- 注册模态框 -->
    <RegisterModal v-if="showRegisterModal" @close="closeModal" @switch-to-login="showLoginModal = true" />
  </div>
</template>
